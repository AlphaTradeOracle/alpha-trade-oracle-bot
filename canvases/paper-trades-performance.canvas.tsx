...
const GENERATED = "2026-07-31 00:32 Europe/Berlin";
const KPI = {
  "start": 5000.0,
  "cash": 4797.97244509,
  "book": 5486.86133398,
  "equity": 5248.08244509,
  "realized": 486.86133398,
  "closedRpnl": 101.75,
  "openN": 5,
  "closedN": 60,
  "pendingN": 2,
...
const TRADE_HEADERS = ["ID", "Symbol", "Side", "Status", "Entry", "SL", "TP1", "TP2", "TP3", "Hits", "RPnL", "Exit", "Opened", "Closed"];
const TRADE_ROWS = [
  [
    "1236",
    "SCUSDT",
...
const TIMELINE_HEADERS = ["Phase", "Date", "Closed", "WR", "PF", "Closed RPnL", "Note"];
const TIMELINE_ROWS = [
  [
    "Baseline (pre-MTF)",
    "2026-07-28",
  ...
  [
    ...
    "1.16",
    "$+132.60",
    "Rescore + rebuild with c8460e6 indicator weights"
  ],
  [
    "ADX \u2265 35 (rejected)",
    "2026-07-30",
  ...
  return (
    <Stack gap={20}>
      <Stack gap={6}>
        ...
        <Text tone="secondary">
          Production VPS · since 2026-07-28 · Stand 2026-07-31 00:32 Europe/Berlin · SIGNAL_MIN_ADX=20 (ADX≥35 rejected)
        </Text>
      </Stack>
