  ...
  return (
    <Stack gap={20}>
      ...
      <Stack gap={8}>
        ...
        <Text tone="secondary" size="small">
          Entry / SL / TP levels · Hit flags (TP1/TP2/TP3) · RPnL · Quelle: VPS Postgres · {GENERATED}
        </Text>
      </Stack>
      ...
      <Card>
        ...
        <CardBody>
          <Text size="small">
            Start ${KPI.start} · Margin $100 · Leverage 10x · MTF v2 weights · SIGNAL_MIN_ADX=20 ·
            Cancelled {KPI.cancelledN} · Update {GENERATED}
          </Text>
        </CardBody>
      </Card>
    </Stack>
