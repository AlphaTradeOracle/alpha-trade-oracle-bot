...
import marketRegimeFallback from '../data/marketRegime.json'
...
export function DeskDataProvider({ children }: { children: ReactNode }) {
  ...
  const [marketRegime, setMarketRegime] = useState<MarketRegimeSnapshot | null>(
    () => marketRegimeFallback as MarketRegimeSnapshot,
  )
  ...
  const refresh = useCallback(async (options?: RefreshOptions) => {
    ...
    try {
      ...
      if (snap.marketRegime) {
        setMarketRegime(snap.marketRegime)
      }
